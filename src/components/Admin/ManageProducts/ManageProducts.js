    ...
    return (
        ...
        <div className="text-center  mb-5 pt-5 pb-5">
            ...
            <div className="container pt-5">
                <h3 className="text-center  p-3 h1Gallery fw-bold mb-3">Popular Drinks</h3>
                ...
                <h3 className="text-center mt-5 h1Gallery p-3 fw-bold mb-3">Popular Ingredients</h3>
                <div className="row row-cols-1 row-cols-sm-2 row-cols-md-2 row-cols-xl-3 g-4 pt-1">
                    {
                ...
                <h3 className="text-center mt-5  h1Gallery  p-3 fw-bold mb-3">Latest Drinks</h3>
                <div className="row row-cols-1 row-cols-sm-2 row-cols-md-2 row-cols-xl-3 g-4 pt-1">
                    {
                        latestDrinks.map(drink => <DrinkShowByName drink={drink} state={true} btnshow={true} drinkname="LatestDrinks"></DrinkShowByName>)
                    }
                </div>
                <h3 className="text-center mt-5  h1Gallery p-3 fw-bold mb-3">Random Ingredients</h3>
                <div className="row row-cols-1 row-cols-sm-2 row-cols-md-2 row-cols-xl-3 g-4 pt-1">
                    {
                ...
                <h3 className="text-center mt-5  h1Gallery p-3 fw-bold mb-3">Random  Drinks</h3>
                <div className="row row-cols-1 row-cols-sm-2 row-cols-md-2 row-cols-xl-3 g-4 pt-1">
                    {
