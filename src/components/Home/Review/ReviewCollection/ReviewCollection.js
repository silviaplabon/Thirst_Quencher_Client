    ...
    return (
        <div className="container my-5">
            ...
            <div className="row mx-1" style={{ backgroundColor: '#333', borderRadius: '0.70rem' }}>
                ...
                <div className="col-md-5 col-lg-6  ms-0 ps-0 pe-0 col-xs-12 col-sm-12 h-100" >
                        ...
                        <div className="carousel-inner p-0">
                            <div className="carousel-item active   h-100 rounded card w-100 cardStyle" style={{ backgroundColor: '#27211D', borderRadius: '0.60rem' }}   >
                                <div className=" text-center cardBackgroundColor ">
                                    <div className=" h-25 px-2 py-3 d-flex justify-content-between align-items-between ">
                ...
                <div className="col-md-7 col-lg-6 col-xs-12 col-sm-12 pt-1 p-0 h-100">
                <ScrollAnimation animateIn='bounceInRight' duration={3}>
                    {/* <h4 className="text-end mt-5 text-white me-3 h4Style ">TESTIMONIALS</h4> */}
                    <p className="text-end text-white me-3 h6Style pt-5" style={{}}>
                    ...
                    <div className="d-flex justify-content-end align-items-end">
                        ...
                        {
                            loggedInUser.email ? <Link to='/user/AddTestimonials' className="  mt-3 me-3 mb-5 btn btnClass  btnReview1 fw-bold">
                                Add a Review</Link> : <> <Link to='/' className="p-2 mt-3 me-3  mb-5 btn btnClass btnReview1 fw-bold">
                                    Add a Review</Link> </>
                        }
                    </div>
                    </ScrollAnimation>
